...
<p>This is a default round <i class="icn-round glyphicons ok_2"></i> icon, and here's icons <i class="icn-round icn-info icon-info"></i> <i class="icn-round icn-error glyphicons remove_2"></i> <i class="icn-round icn-success glyphicons ok_2"></i> <i class="icn-round icn-warning icon-exclamation"></i> with the semantic classes. You can use any icon with these. They just change background color.</p>

Note that these classes
