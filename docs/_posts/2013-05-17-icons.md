...
<p>You can also create small versions of round icons by adding a class of "small", like this: <i class="icn-round small glyphicons ok_2"></i> <i class="icn-round small icn-info icon-info"></i> <i class="icn-round small icn-error glyphicons remove_2"></i> <i class="icn-round small icn-success glyphicons ok_2"></i> <i class="icn-round small icn-warning icon-exclamation"></i> <i class="icn-round icn-info small glyphicons roundabout"></i>.</p>

~~~html
<i class="icn-round small ICONCLASS"></i>
<i class="icn-round small icn-info ICONCLASS"></i>
<i class="icn-round small icn-error ICONCLASS"></i>
<i class="icn-round small icn-success ICONCLASS"></i>
<i class="icn-round small icn-warning ICONCLASS"></i>
~~~
